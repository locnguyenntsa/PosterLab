    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 28 }}>
        <div style={{ width: 320 }}>
          ...
          {totals.addonEur > 0 && <Row label="Digital version" value={formatEUR(totals.addonEur)} />}
      ...
      <div style={{ marginTop: 'auto', borderTop: `1px solid ${LINE}`, paddingTop: 20 }}>
        ...
        <div style={{ fontSize: 12, color: MUTE, marginTop: 6, lineHeight: 1.6 }}>
          Print on demand · Framed · Ships in 5–7 days. Questions? Reply to your confirmation email.
          This document was generated by Poster Lab and serves as your purchase receipt.
        </div>
      </div>
    </div>
  )
